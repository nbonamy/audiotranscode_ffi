...
#ifdef _MSC_VER
// fmpeg 6.0 downloaded from
// //https ://github.com/sudo-nautilus/FFmpeg-Builds-Win32
#pragma comment(lib, "avcodec-60.lib")
#pragma comment(lib, "avformat-60.lib")
#pragma comment(lib, "avutil-58.lib")
...
#undef av_err2str
string CAudioTranscoder::av_err2string(int errnum)
{
 ...
 */
int CAudioTranscoder::open_input_file(const char *filename,
                                      ...
                                      AVCodecContext **input_codec_context)
{
  ...
  AVCodecParameters *input_codec_params = (*input_format_context)->streams[audio_stream_index]->codecpar;
  AVCodecID input_codec_id = input_codec_params->codec_id;
  if (!(input_codec = avcodec_find_decoder(input_codec_id)))
  {
  ...
  error = avcodec_parameters_to_context(avctx, input_codec_params);
  if (error < 0)
  {
    avformat_close_input(input_format_context);
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::open_output_file(const char *filename,
                                       AVCodecContext *input_codec_context,
 ...
 */
void CAudioTranscoder::init_packet(AVPacket **packet)
{
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::init_input_frame(AVFrame **frame)
{
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::init_resampler(AVCodecContext *input_codec_context,
                                     AVCodecContext *output_codec_context,
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::init_fifo(AVAudioFifo **fifo, AVCodecContext *output_codec_context)
{
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::write_output_file_header(AVFormatContext *output_format_context)
{
  int error;
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::decode_audio_frame(AVFrame *frame,
                                         AVFormatContext *input_format_context,
                                         AVCodecContext *input_codec_context,
                                         int *data_present, int *finished)
{
  ...
  /* Check it comes from the audio stream */
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::init_converted_samples(uint8_t ***converted_input_samples,
                                             AVCodecContext *output_codec_context,
                                             int frame_size)
{
  int error;
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::add_samples_to_fifo(AVAudioFifo *fifo,
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::read_decode_convert_and_store(AVAudioFifo *fifo,
                                                    AVFormatContext *input_format_context,
                                                    AVCodecContext *input_codec_context,
                                                    AVCodecContext *output_codec_context,
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::init_output_frame(AVFrame **frame,
                                        AVCodecContext *output_codec_context,
                                        int frame_size)
{
  int error;
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::encode_audio_frame(AVFrame *frame,
                                         AVFormatContext *output_format_context,
                                         AVCodecContext *output_codec_context,
                                         int *data_present)
{
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::load_encode_and_write(AVAudioFifo *fifo,
                                            AVFormatContext *output_format_context,
                                            AVCodecContext *output_codec_context)
{
 ...
 * @return Error code (0 if successful)
 */
int CAudioTranscoder::write_output_file_trailer(AVFormatContext *output_format_context)
{
  int error;
...
int CAudioTranscoder::transcode(const char *input_filename, const char *output_filename)
{
